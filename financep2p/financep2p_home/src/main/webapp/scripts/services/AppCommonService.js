var option = {
    'url':{
        'api_user':'/financep2p_action/user/', //用户相关
        'api_investment':'/financep2p_action/investment/', 
        'api_productRate':'/financep2p_action/productRate/',
        'api_product':'/financep2p_action/product/', 
        'api_productAccount':'/financep2p_action/productaccount/',
        'api_acount':'/financep2p_action/account/',
        'api_verification':'/financep2p_action/verification/',
        'api_emailAuth':'/financep2p_action/emailAuth/',
        'api_paymentpwd':'/financep2p_action/paymentpwd/',
        'api_extracts':'/financep2p_action/extracts/',  //提现与支付功能
        'api_bankcardInfo':'/financep2p_action/bankCardInfo/',
        'api_charges':'/financep2p_action/charges/'
    },
    'header':{
        'headers':{
